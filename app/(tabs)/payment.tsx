import { View, Text, TouchableOpacity, Alert, ImageBackground, Platform } from 'react-native';
...
export default function Payment() {
  // Conditionally load native-only map components (avoid bundling on web)
      ...
      <View style={{ flex: 1, padding: 24, justifyContent: 'center' }}>
        ...
        {!paid ? (
          ...
          <View style={{ alignItems: 'center', flex: 1 }}>
            ...
            {Platform.OS !== 'web' && watching && location ? (
              <MapView
                style={{
                  width: '100%',
                  height: 250,
